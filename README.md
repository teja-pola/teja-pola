...
<p align="left">
  <img src="https://skillicons.dev/icons?i=react,nextjs,nodejs,figma,ts,js,mongodb,azure,babel,bash,bootstrap,bun,c,cloudflare,deno,django,express,firebase,flask,gcp,vite,xd,npm,workers,wordpress,materialui,tailwind,java,python,git,github,aws,docker,postman,py,ruby,supabase,postgres" />
</p>
